...
@section('maincontent')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Data Regangan Geser Tanah</h3>
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Data Regangan Geser Tanah</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Data Regangan Geser Tanah</h5>
                    <div class="d-flex">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn icon btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#updateModal{{ $rg->id }}">
                                                <i class="bi bi-pencil"></i>
                                            </button>
                                            <!-- Tombol Hapus dengan SweetAlert -->
                                            <button class="btn icon btn-danger delete-button"
                                                data-id="{{ $rg->id }}" data-nama="{{ $rg->ukuranregangan }}">
                                                <i class="bi bi-trash3-fill"></i>
                                            </button>
                                        </td>
                                    </tr>
                                    @include('AdminPage.reganganFeatures.update-modals', [
                                        'regangan' => $rg
                                    ])
                                @endforeach
                            </tbody>
    ...
    <!-- Default size Modal -->
    @include('AdminPage.reganganFeatures.create-modals')
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function(e) {
                    e.preventDefault();
                    const reganganID = this.getAttribute('data-id');
                    const reganganNama = this.getAttribute('data-nama');

                    // SweetAlert untuk konfirmasi
                    Swal.fire({
                        title: 'Apakah Anda yakin?',
                        text: `Data ${reganganNama} akan dihapus!`,
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            ...
                            form.action = `/regangans/${reganganID}`;
                            form.method = 'POST';
            ...
            pdfButton.addEventListener('click', function() {
                ...
                fetch('{{ route('regangans.exportPDF') }}')
