    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item  ">
                            <a href="{{ route('snis.index') }}" class="submenu-link">Kategori SNI</a>

                        </li>

                        <li class="submenu-item  ">
                            <a href="{{ route('jenistanahs.index') }}" class="submenu-link">Faktor Amplifikasi</a>

                        </li>

                        <li class="submenu-item  ">
                            <a href="{{ route('klasifikasitanahs.index') }}" class="submenu-link">Klasifikasi Tanah</a>

                        </li>

                        <li class="submenu-item  ">
                            <a href="{{ route('regangans.index') }}" class="submenu-link">Regangan Geser Tanah</a>
                ...
                <li class="sidebar-title">Data Spasial</li>

                <li class="sidebar-item {{ Route::currentRouteName() === 'desas.index' ? 'active' : '' }} ">
                    <a href="{{ route('desas.index') }}" class='sidebar-link'>
                ...
                <li class="sidebar-item {{ Route::currentRouteName() === 'spatial.index' ? 'active' : '' }} ">
                    <a href="{{ route('spatial.index') }}" class='sidebar-link'>
                        <i class="bi bi-stack"></i>
                ...
                <li class="sidebar-item {{ Route::currentRouteName() === 'allmaps' ? 'active' : '' }} ">
                    <a href="{{ route('allmaps') }}" class='sidebar-link'>
                        <i class="bi bi-stack"></i>
                        <span>Peta Marker</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item {{ Route::currentRouteName() === 'allmaps' ? 'active' : '' }} ">
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class=" btn btn-danger logout-button"><i class="bi bi-stack me-3"></i>Logout</button>
                    </form>
                </li>
