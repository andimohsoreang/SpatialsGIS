...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('auth/dist/style.css') }}"> <!-- Sesuaikan dengan path css Anda -->
</head>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="email">
                ...
                <div class="sec-2">
                    ...
                    <input type="email" name="email" placeholder="Username@gmail.com" value="{{ old('email') }}"
                        required autofocus />
                </div>
                @error('email')
